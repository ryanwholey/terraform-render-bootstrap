...
variable "container_images" {
  ...
  default = {
    calico                  = "quay.io/calico/node:v3.16.1"
    calico_cni              = "quay.io/calico/cni:v3.16.1"
    ...
    kube_apiserver          = "k8s.gcr.io/kube-apiserver:v1.19.0"
    kube_controller_manager = "k8s.gcr.io/kube-controller-manager:v1.19.0"
    kube_scheduler          = "k8s.gcr.io/kube-scheduler:v1.19.0"
    kube_proxy              = "k8s.gcr.io/kube-proxy:v1.19.0"
    # experimental
    cilium_agent    = "docker.io/cilium/cilium:v1.8.3"
    cilium_operator = "docker.io/cilium/operator-generic:v1.8.3"
  }
}
